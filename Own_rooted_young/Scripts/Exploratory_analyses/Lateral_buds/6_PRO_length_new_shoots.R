...
new_shoots.rank = table(new_shoots$rank_node, new_shoots$length_newshoots, new_shoots$fate)
...
#visualize plot
str(MV.bud.PRO)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$length,pch=19)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$rank_node,pch=19)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$fate,pch=19)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$`Length(node)`,pch=19)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$m,pch=19)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$v,pch=19)
plot(MV.bud.PRO$length2yo~MV.bud.PRO$siblings_mv,pch=19)
...
#graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_fromV_newshootclass.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
...
#graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_fromV_freq_newshootclass.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
col = brewer.pal(n = 4, name = "Set1")
with(
...
#graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_fromM_newshootclass.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
col = brewer.pal(n = 4, name = "Set1")
with(
  fromM.matrix,
...
# graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_fromM_freq_newshootclass.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
col = brewer.pal(n = 4, name = "Set1")
with(
  fromM.freq.matrix,
...
lne = grep("length_newshoots", colnames(MV.bud.PRO))#adress the column with the class of the child
...
#graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_fromMV_newshootclass.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
...
#graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_fromMV_freq_newshootclass.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
...
# AIM2: Relationship parent length ~ new shoots length --------------------
df.shoot=unique(bud.proleptic[bud.proleptic$nb_new_shoots != 0, 6:7])
...
new_class=table(bud.proleptic$class, bud.proleptic$length_newshoots)
...
# pdf("Own_rooted_young/Outputs/Tables/PRO_new_shoots~class.pdf", height = 5,width = 12)
...
#graph
# png("Own_rooted_young/Outputs/Plots/6_PRO_lenchil~lenpar.png",width=1200, height=900, res=150)# save plot

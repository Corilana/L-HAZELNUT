...
# pdf("Own_rooted_young/Outputs/Tables/PRO_obs~class.pdf",height = 8,width = 10)
...
#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_freq_obs~class.png",width=1200, height=900, res=150)# save plot
...
#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_nb_obs~class.png",width=1200, height=900, res=150)# save plot
par(mar = c(5, 5, 4, 6))
...
#graph
# png("Own_rooted_young/Outputs/Plots/PRO_nb_obs.png",width=1200, height=900, res=150)# save plot
cols<-brewer.pal(n=4,name="Set2")
...
#write pdf with the table
# pdf("Own_rooted_young/Outputs/Tables/PRO_obs~rank.pdf",height = 8,width = 10 )
grid.table(class.rank)
# dev.off()

#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_freq_obs~rank.png.png",width=1200, height=900, res=150)# save plot
par(mar=c(5,5,5,4))
...
freq.rank = table(met$rank_node, met$tot_buds_m_v_b_c)
print(freq.rank)

#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_nb_multiple~rank.png",width=1200, height=900, res=150)# save plot
...
#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_freq_multiple~rank.png",width=1200, height=900, res=150)# save plot
...
#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_nb_type_multiple~rank.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
cols <-
...
#graph
# png("Own_rooted_young/Outputs/Plots/2_PRO_freq_type_multiple~rank.png.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
cols <-
  c(brewer.pal(name = "Spectral", n = 11)[c(2:5, 9:11)],
    brewer.pal(name = "Dark2", n = 7))

...
library(RColorBrewer);library(gridExtra);library(tidyr)

#visualize plot
plot(tot_buds_syl_m_v~parent_length_cm,met.sylleptic, pch=19)
plot(tot_buds_syl_m_v~parent_rank_node,met.sylleptic, pch=19)
plot(tot_buds_syl_m_v~abs_norm_median_distance,met.sylleptic, pch=19)
plot(tot_buds_syl_m_v~abs_median_distance,met.sylleptic, pch=19)
plot(tot_buds_syl_m_v~median_distance,met.sylleptic, pch=19)
plot(tot_buds_syl_m_v~norm_median_distance,met.sylleptic, pch=19)
...
rank.freq = table(met.sylleptic$parent_rank_node, met.sylleptic$tot_buds_syl_m_v)

#graph
# png("Own_rooted_young/Outputs/Plots/3_SYL_nb_mv~rank.png",width = 1200,height = 900,res = 150)# save plot
...
#graph
# png("Own_rooted_young/Outputs/Plots/3_SYL_freq_mv~rank.png",width = 1200,height = 900,res = 150)# save plot
...
#graph
# png("Own_rooted_young/Outputs/Plots/3_SYL_nb_mv_multiple~rank.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
...
#graph
# png("Own_rooted_young/Outputs/Plots/3_SYL_freq_mv_multiple~rank.png",width = 1200,height = 900,res = 150)# save plot
par(mar = c(5, 5, 4, 10))
cols <-c(brewer.pal(n = 12, name = "Set3"),brewer.pal(n = 10, name = "Paired"))         
x <-
  barplot(
